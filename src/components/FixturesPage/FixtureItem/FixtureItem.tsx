...
export function FixtureItem(props: Props): React.ReactElement {
  ...
  return (
    <ListItem divider className={classes.root}>
      ...
      <ListItemText disableTypography>
        ...
        <Hidden mdUp>
          <Link className={classes.contentBig} color="secondary" component={NavLink} to={fixtureLink}>
            <div className={classes.contentBigLeft}>
              <FixtureTeam
                isWinner={fixture.winner_team_id === fixture.localteam_id}
                teamName={(!settings.originalNames && fixture.localteam_name_loc) || fixture.localteam_name}
                teamStat={fixture.stats.find((stat) => stat.team_id === fixture.localteam_id)}
            ...
            {isScheduled(fixture.time.status) || isPostponed(fixture.time.status) ? (
              ...
              <div className={classes.contentBigRight}>
                {isLiveFlag && (
                  <Typography className={classes.minute}>
                    {(fixture.time.minute ?? 0) + (fixture.time.extra_minute ?? 0)}&apos;
                  </Typography>
                )}
                <div className={classes.contentBigRightScore}>
                  <Typography color={isLiveFlag ? "primary" : "secondary"}>{fixture.scores.localteam_score}</Typography>
                  <Typography color={isLiveFlag ? "primary" : "secondary"}>
...
export default observer(FixtureItem);
